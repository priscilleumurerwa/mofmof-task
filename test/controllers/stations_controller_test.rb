...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { how_many_minutes_walks: @station.how_many_minutes_walks, name_of_railway_line: @station.name_of_railway_line, statation_name: @station.statation_name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { how_many_minutes_walks: @station.how_many_minutes_walks, name_of_railway_line: @station.name_of_railway_line, statation_name: @station.statation_name } }
